...
const Features = () => {
  return (
    <div className="features-container">
      <h2 className="title">Taste of Africa</h2>
      <div className="cards">
        <div className="card">
          ...
          <p className="origin"><strong>Origin:</strong> Originating from the Wolof people of Senegal, Jollof Rice has become a symbol of cultural pride across West Africa, with regional variations found in Nigeria, Ghana, and beyond.</p>
        </div>
        <div className="card">
          ...
          <p className="origin"><strong>Origin:</strong> Ugali has roots in East Africa and is a daily meal for many households. It reflects the agricultural lifestyle and the importance of maize in the region's diet.</p>
        </div>
        <div className="card">
          ...
          <p className="origin" style={{marginTop:"-0.9rem"}}><strong>Origin:</strong> Hailing from Ethiopia, Injera with Doro Wat is more than just food; it is an integral part of social gatherings and religious ceremonies.</p>
        </div>
      </div>
    </div>
  );
